...
function PackageDetail() {
  ...
  if (!site || !site.description || site.description.length === 0) return null;
  const stars = Array(Math.round(site?.rating || 0)).fill(0);
  const description = site.description[0] || {};
  const descriptionMain = description.main?.[0] || "No description available.";
  const descriptionIncluded = description.included || [];
  const descriptionNotIncluded = description.notIncluded || [];
  const descriptionExpect = description.expect || [];
  const descriptionAdditional = description.additionalInfo || [];
  const descriptionPolicy = description.policy?.[0] || "Standard cancellation policy applies.";
      ...
      <div className="container-md">
        <div className=" row m-0 mt-2">
          ...
          <div className="pkg-detail col-12 col-md-6 ">
            ...
            {descriptionMain && <p className="text-start py-2 ">{descriptionMain}</p>}
            <div className="text-start">
              {stars.map((_, index) => {
                return <FaStar key={index} style={{ color: "var(--primary)" }} />;
              })}
            </div>
            <div className="d-flex justify-content-between align-items-center">
              <h4 className="lead fs-4 rounded-pill py-4 text-start">
                ₹{site.pricePerAdult} Per adult
              </h4>
              <div
                style={{ height: "50px" }}
              ...
              >
                {!itemAdded && (
                  <button
                    ...
                    onClick={() => {
                      addToCart({
                        user: user.user?._id || user._id, // Support both structures
                        packages: site._id,
                        name: site.name,
        ...
        <div className="row align-items-center">
          ...
          >
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  {descriptionIncluded.map((info, index) => {
                    return (
                      <p key={index}>
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  {descriptionNotIncluded.map((info, index) => {
                    return (
                      <p key={index}>
                        <GiSupersonicBullet /> {info}
                      </p>
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  {descriptionExpect.map((ex, i) => {
                    return (
                      <div key={i}>
                        {Array.isArray(ex) ? ex.map((e, idx) => {
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  {descriptionAdditional.map((info, index) => {
                    return (
                      <p key={index}>
                        <GiSupersonicBullet /> {info}
                      </p>
            ...
            <div className="accordion-item">
              ...
              <div
                ...
                data-bs-parent="#accordionFlushExample"
              >
                <div className="accordion-body">{descriptionPolicy}</div>
              </div>
            </div>
          </div>
        </div>
